# Complex synthesis using premade Copper (ii) chloride and Piroctone Olamine solutions.
...
class SynthesisDemo:
    """Educational wrapper exposing only basic functionality.
